...
- **Source tag:** `exp-001-002-evidence-v1`
...
| Location | Contents |
|---|---|
| **GitHub** (this repo, at the source tag) | code (`src/`, `scripts/`), configs, tests, requirements, experiment reports (`agent-BuildReports/experiments/`), this manifest + small summaries (`agent-BuildReports/experiments/EXP-001-002-supporting-evidence/`), PROJECT_STATUS/RESOURCES/AGENT_PROTOCOL |
